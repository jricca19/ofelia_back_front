      ...
      <div className="section-reveal mx-auto w-full max-w-3xl text-center">
        ...
        <div className="mx-auto mt-8 max-w-2xl space-y-5 text-sm leading-7 text-[#5a5252] md:text-base md:leading-8">
          <p>
            ...
            procedencia, técnica y estado, priorizando restauraciones discretas que no alteren
            su carácter original.
          </p>
          <p>
            Trabajo para quienes desean integrar historia real en sus espacios, con una compra
            informada y personalizada.
          </p>
        </div>
        <p className="mt-8 font-serif text-2xl italic text-[#b87682]">&ldquo;Tienda de Antigüedades&rdquo;</p>
      </div>
    </section>
  );
}

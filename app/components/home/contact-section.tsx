      ...
      <div className="section-reveal mx-auto w-full max-w-5xl text-center">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-start">
          <form className="space-y-5 text-left">
            <label className="block text-xs tracking-[0.18em] text-[#6e6764] uppercase">
              Nombre
            </label>
            <input
              type="text"
              ...
              className="w-full border border-[#d6c8bd] bg-[#fdf6ec] px-4 py-3 text-sm outline-none placeholder:text-[#b89f8e] focus:border-[#b87682]"
            />
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex w-full items-center justify-center bg-[#b07a88] px-6 py-4 text-xs font-semibold tracking-[0.2em] text-[#f8e6c8] transition hover:bg-[#a66773]"
            >
              ENVIAR VÍA WHATSAPP
            </a>
          </form>
          ...
          <div className="mx-auto w-full max-w-md text-left">
            ...
            <div className="mt-6 space-y-4 text-[1.75rem] leading-7 text-[#5a5252]">
              <a
                href="https://wa.me/59899000000"
                target="_blank"
                rel="noreferrer"
                className="flex items-start gap-3 text-sm transition hover:text-[#b87682]"
              >
              ...
              <a href="tel:+5982000000" className="flex items-start gap-3 text-sm transition hover:text-[#b87682]">
                <svg viewBox="0 0 24 24" aria-hidden="true" className="mt-0.5 h-5 w-5 text-[#b87682]" fill="none" stroke="currentColor">
              ...
              <a href={emailHref} className="flex items-start gap-3 text-sm transition hover:text-[#b87682]">
                <svg viewBox="0 0 24 24" aria-hidden="true" className="mt-0.5 h-5 w-5 text-[#b87682]" fill="none" stroke="currentColor">
